...
ggsave(plot = q, "~/Documents/temp.pdf", width = 2.22, height = 3.6)
...
stat_summary(fun=median, geom="point", color="blue",
             ...
             size=0.1)+
  stat_summary(aes(color=bin),fun.data = mean_se)+
scale_fill_manual(values = colB)+
...
p
ggsave(plot = p, "~/Documents//Burden1_vs_TPM.pdf",width = 4, height = 3)

```


## Tissue expression VS mutation burden
