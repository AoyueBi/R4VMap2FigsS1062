...
p
ggsave(p,filename = "~/Documents/p4.png",height = 5.94,width = 7.82,units = "cm")

### for manuscript
p <- df %>% 
  # filter(! Taxa %in%  c("AB_183","AB_185","AB_039")) %>%
  ggplot(aes(x=Dim.1,y=Dim.2,color= Subspecies_by6_TreeValidated))+
  # geom_point(aes(color=Subspecies),alpha=0.5,size=2)+
...
p
ggsave(p,filename = "~/Documents/p4.pdf",height = 1.3,width = 1.7)
...
ggsave(p,filename = "~/Documents/p.png",height = 8.56,width = 10.29,units = "cm")
...
ggsave(p,filename = "~/Documents/test.pdf",height = 2.4,width = 5.35)
...
ggsave(p2,filename = "~/Documents/p.png",height = 8.56,width = 10.29,units = "cm")
...
ggsave(p,filename = "~/Documents/test.pdf",height = 1.238,width = 1.315)
ggsave(p,filename = "~/Documents/test.pdf",height = 1.25,width = 3)
...
ggsave(p,filename = "~/Documents/test.pdf",height = 2.57,width = 4)
ggsave(p,filename = "~/Documents/p.png",height = 6.66,width = 10.29,units = "cm")
...
# ggsave(p,filename = "/Users/Aoyue/Documents/testk.pdf",height = 4.5,width = 6)
ggsave(p,filename = "/Users/Aoyue/Documents/testk2.png",height = 7.62,width = 10.16,units = "cm")
...
q
ggsave(q,filename = "~/Documents/test.pdf",height = 2.5,width = 3.36)
